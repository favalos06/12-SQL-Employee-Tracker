...
async function viewByDepartment() {
  ...
  const departEmployees = await db.promise()
    .query(`SELECT departments.department_name, roles.department_id, employees.first_name, employees.last_name, employees.role_id, roles.role_title
    FROM ((employees
